...
(function () {
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Projet système — ludostat · 8 leçons</div>' +
  ...
  var next = DAY.num < 8 ? '<a href="lecon' + pad(DAY.num + 1) + '.html">Leçon ' + (DAY.num + 1) + " →</a>" : "<span></span>";
