...
(function () {
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Projet outillé — La Ludothèque pro (C++ · conteneurisé · CI/CD · sécurisé) · 21 leçons</div>' +
  ...
  function updateScore() {
    ...
    try {
      var key = "projcpppro21-l" + DAY.num;
      var prev = parseInt(localStorage.getItem(key) || "0", 10);
      if (pts > prev) localStorage.setItem(key, String(pts));
      localStorage.setItem("projcpppro21-total-l" + DAY.num, String(totalQuestions));
