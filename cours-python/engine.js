/* ===== Moteur du cours Python — rend la page à partir de l'objet DAY ===== */
(function () {
  "use strict";
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Python — 21 leçons</div>' +
  ...
  wrap.appendChild(el("footer", "pagefoot", "Leçon " + DAY.num + " / 21 — Refais les exercices jusqu'à obtenir un score parfait : c'est la répétition qui crée l'automatisme. Et code chaque exemple dans un vrai interpréteur Python !"));
  ...
  function buildQuestion(ex, id, label) {
    ...
    if (ex.type === "qcm") {
      ...
      // mais l'ordre reste stable d'un rechargement à l'autre pour une même question.
