...
(function () {
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Projet full-stack — La Ludothèque (PHP · Laravel · MySQL) · 21 leçons</div>' +
  ...
  function updateScore() {
    ...
    try {
      var key = "projphp21-l" + DAY.num;
      var prev = parseInt(localStorage.getItem(key) || "0", 10);
      if (pts > prev) localStorage.setItem(key, String(pts));
      localStorage.setItem("projphp21-total-l" + DAY.num, String(totalQuestions));
