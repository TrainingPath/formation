/* ===== Moteur du cours initiation-bdd — rend la page à partir de l'objet DAY ===== */
(function () {
  "use strict";
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Initiation aux bases de données — 31 jours</div>' +
  ...
  function updateScore() {
    ...
    try {
      var key = "initbdd31-j" + DAY.num;
      var prev = parseInt(localStorage.getItem(key) || "0", 10);
      if (pts > prev) localStorage.setItem(key, String(pts));
      localStorage.setItem("initbdd31-total-j" + DAY.num, String(totalQuestions));
