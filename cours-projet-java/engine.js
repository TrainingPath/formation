...
(function () {
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Projet full-stack — La Ludothèque (Java · Spring · MySQL) · 21 leçons</div>' +
  ...
  function updateScore() {
    ...
    try {
      var key = "projjava21-l" + DAY.num;
      var prev = parseInt(localStorage.getItem(key) || "0", 10);
      if (pts > prev) localStorage.setItem(key, String(pts));
      localStorage.setItem("projjava21-total-l" + DAY.num, String(totalQuestions));
