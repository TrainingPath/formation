...
(function () {
  ...
  var header = el("header", "day-header",
    '<div class="kicker">L\'ORM de Django — la persistance de la Ludothèque · 21 leçons</div>' +
  ...
  function updateScore() {
    ...
    try {
      var key = "djangoorm21-l" + DAY.num;
      var prev = parseInt(localStorage.getItem(key) || "0", 10);
      if (pts > prev) localStorage.setItem(key, String(pts));
      localStorage.setItem("djangoorm21-total-l" + DAY.num, String(totalQuestions));
