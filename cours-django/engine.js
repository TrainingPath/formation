/* ===== Moteur du cours Django — rend la page à partir de l'objet DAY ===== */
(function () {
  "use strict";
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Django — 21 leçons</div>' +
  ...
  wrap.appendChild(el("footer", "pagefoot", "Leçon " + DAY.num + " / 21 — Refais les exercices jusqu'à obtenir un score parfait. Et code chaque exemple dans un vrai projet Django : lance le serveur et regarde !"));
