...
(function () {
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Java — 31 leçons</div>' +
  ...
  wrap.appendChild(el("footer", "pagefoot", "Leçon " + DAY.num + " / 31 — Refais les exercices jusqu'à obtenir un score parfait : c'est la répétition qui crée l'automatisme."));
