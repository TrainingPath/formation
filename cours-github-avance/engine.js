/* ===== Moteur du cours github-avance — rend la page à partir de l'objet DAY ===== */
(function () {
  "use strict";
  ...
  var header = el("header", "day-header",
    '<div class="kicker">GitHub — intermédiaire à avancé — 31 jours</div>' +
