/* ===== Moteur du cours SQL Server — rend la page à partir de l'objet DAY ===== */
(function () {
  "use strict";
  ...
  var header = el("header", "day-header",
    '<div class="kicker">SQL Server — T-SQL · 21 leçons</div>' +
  ...
  wrap.appendChild(el("footer", "pagefoot", "Leçon " + DAY.num + " / 21 — Refais les exercices jusqu'à un score parfait. Et surtout, exécute chaque requête dans SSMS : le T-SQL s'apprend en interrogeant de vraies données !"));
