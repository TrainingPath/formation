/* ===== Moteur du cours ad-scripts — rend la page à partir de l'objet DAY ===== */
(function () {
  "use strict";
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Active Directory — scripts PowerShell — 31 jours</div>' +
  ...
  function updateScore() {
    ...
    try {
      var key = "adscript31-j" + DAY.num;
      var prev = parseInt(localStorage.getItem(key) || "0", 10);
      if (pts > prev) localStorage.setItem(key, String(pts));
      localStorage.setItem("adscript31-total-j" + DAY.num, String(totalQuestions));
