...
(function () {
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Conteneurs — La Ludothèque en conteneurs (Docker) · 21 leçons</div>' +
