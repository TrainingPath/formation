/* ===== Moteur du cours projet-sgbd — rend la page à partir de l'objet DAY ===== */
(function () {
  "use strict";
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Projet de développement SGBD — 31 jours</div>' +
