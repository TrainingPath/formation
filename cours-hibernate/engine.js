...
(function () {
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Hibernate / JPA — la persistance de la Ludothèque · 21 leçons</div>' +
  ...
  function updateScore() {
    ...
    try {
      var key = "hibernate21-l" + DAY.num;
      var prev = parseInt(localStorage.getItem(key) || "0", 10);
      if (pts > prev) localStorage.setItem(key, String(pts));
      localStorage.setItem("hibernate21-total-l" + DAY.num, String(totalQuestions));
