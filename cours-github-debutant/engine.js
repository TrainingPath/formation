/* ===== Moteur du cours github-debutant — rend la page à partir de l'objet DAY ===== */
(function () {
  "use strict";
  ...
  var header = el("header", "day-header",
    '<div class="kicker">GitHub — débutant à intermédiaire — 31 jours</div>' +
