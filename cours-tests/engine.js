...
(function () {
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Tests &amp; qualité logicielle — tester la Ludothèque · 21 leçons</div>' +
