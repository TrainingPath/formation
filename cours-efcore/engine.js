...
(function () {
  ...
  var header = el("header", "day-header",
    '<div class="kicker">EF Core — la persistance de la Ludothèque · 21 leçons</div>' +
