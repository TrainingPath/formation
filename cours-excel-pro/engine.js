/* ===== Moteur du cours excel-pro — rend la page à partir de l'objet DAY ===== */
(function () {
  "use strict";
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Excel avancé & pro — 31 jours</div>' +
  ...
  function updateScore() {
    ...
    try {
      var key = "excelpro31-j" + DAY.num;
      var prev = parseInt(localStorage.getItem(key) || "0", 10);
      if (pts > prev) localStorage.setItem(key, String(pts));
      localStorage.setItem("excelpro31-total-j" + DAY.num, String(totalQuestions));
