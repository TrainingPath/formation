/* ===== Moteur du cours anglais A2 — rend la page à partir de l'objet DAY ===== */
(function () {
  "use strict";
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Anglais A2 — 30 jours</div>' +
