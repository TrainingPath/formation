...
(function () {
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Git — les bases · 10 leçons</div>' +
  ...
  var next = DAY.num < 10 ? '<a href="lecon' + pad(DAY.num + 1) + '.html">Leçon ' + (DAY.num + 1) + " →</a>" : "<span></span>";
  ...
  wrap.appendChild(el("footer", "pagefoot", "Leçon " + DAY.num + " / 10 — Refais les exercices jusqu'à obtenir un score parfait : c'est la répétition qui crée l'automatisme."));
