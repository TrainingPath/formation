...
(function () {
  ...
  var header = el("header", "day-header",
    '<div class="kicker">CI/CD &amp; Git avancé — La livraison automatisée · 21 leçons</div>' +
