/* ===== Moteur du cours espagnol B1 — rend la page à partir de l'objet DAY ===== */
(function () {
  "use strict";
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Espagnol B1 — 30 jours</div>' +
