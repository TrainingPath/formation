/* ===== Moteur du cours Linux — rend la page à partir de l'objet DAY ===== */
(function () {
  "use strict";
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Linux — 31 leçons</div>' +
  ...
  var next = DAY.num < 31 ? '<a href="lecon' + pad(DAY.num + 1) + '.html">Leçon ' + (DAY.num + 1) + " →</a>" : "<span></span>";
  ...
  wrap.appendChild(el("footer", "pagefoot", "Leçon " + DAY.num + " / 31 — Refais les exercices jusqu'à obtenir un score parfait : c'est la répétition qui crée l'automatisme. Et surtout : tape chaque commande dans un vrai terminal !"));
  ...
  function balanceOpts(ex) {
    ...
    var tails = [
      ...
      ", à condition d'installer un paquet supplémentaire",
      ...
      ", ce qui ralentirait inutilement le système",
