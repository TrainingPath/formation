/* ===== Moteur du cours neerlandais B1 — rend la page à partir de l'objet DAY ===== */
(function () {
  "use strict";
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Néerlandais B1 — 30 jours</div>' +
  ...
  var next = DAY.num < 30 ? '<a href="jour' + pad(DAY.num + 1) + '.html">Jour ' + (DAY.num + 1) + " →</a>" : "<span></span>";
  ...
  wrap.appendChild(el("footer", "pagefoot", "Jour " + DAY.num + " / 30 — Refais les exercices jusqu'à obtenir un score parfait : c'est la répétition qui crée l'automatisme."));
