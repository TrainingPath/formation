...
(function () {
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Projet outillé — La Ludothèque pro (PHP · Laravel, conteneurisé · CI/CD · sécurisé) · 21 leçons</div>' +
  ...
  function updateScore() {
    ...
    try {
      var key = "proj6php21-l" + DAY.num;
      var prev = parseInt(localStorage.getItem(key) || "0", 10);
      if (pts > prev) localStorage.setItem(key, String(pts));
      localStorage.setItem("proj6php21-total-l" + DAY.num, String(totalQuestions));
