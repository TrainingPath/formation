...
(function () {
  ...
  var header = el("header", "day-header",
    '<div class="kicker">Sécurité applicative — Sécuriser la Ludothèque · 21 leçons</div>' +
